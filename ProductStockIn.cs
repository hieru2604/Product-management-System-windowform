...
namespace LaptopDemo
{
    public partial class ProductStockIn : Form
    {
        ...
        public void LoadProduct()               
        {
            ...
            cm = new SqlCommand("SELECT pcode, pname, qty FROM tbProducts ", cn);
            cn.Open();
            dr = cm.ExecuteReader();
            while (dr.Read())
            {
        ...
        private void dgvProduct_CellContentClick(object sender, DataGridViewCellEventArgs e)    //select product to stockin
        {
